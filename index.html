...
<ul class="nav-list">
<div class="logo">
<img src= "./inf-tech logo.png">
</div>
<li><a href="#web"> <?php echo 'Web Technology' ?></a></li>
<li><a href="#program"><?php echo 'C Programming ' ?></a></li>
...
<div class="paras">
<h1 class="sectionTag text-big"><?php echo 'Java' ?></h1>
...
<div class="thumbnail">
<img src= "./computer image.jpg" alt="laptop image">
</div>
</section>
